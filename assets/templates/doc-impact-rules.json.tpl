  ...
  "rules": [
    {
      ...
      "guidance": "至少更新 docs/project/API-SPEC.md 或对应功能目录下的 api-spec.md。",
      "code_patterns": [
      ...
      "required_doc_patterns_any": [
        ...
        "^docs/features/[^/]+/api-spec\\.md$"
      ]
    },
    {
      "id": "java-db-change",
      "description": "数据库结构、迁移脚本或 Mapper 变更时，必须同步数据库文档。",
      "guidance": "至少更新对应功能目录下的 db-spec.md；如果属于跨功能的共享约束，补充项目级 DESIGN.md。",
      "code_patterns": [
    ...
    },
    {
      ...
      "guidance": "至少更新 docs/project/SECURITY.md；如果只影响某个功能，也可以同时补充对应功能设计文档。",
      "code_patterns": [
    ...
    },
    {
      ...
      "guidance": "至少更新 docs/project/DEVELOPMENT.md，或对应功能目录下的 rollout.md。",
      "code_patterns": [
        "^pom\\.xml$",
        "^build\\.gradle$",
        "^build\\.gradle\\.kts$",
      ...
      "required_doc_patterns_any": [
        ...
        "^docs/features/[^/]+/rollout\\.md$"
      ]
    },
    {
      "id": "architecture-rule-change",
      "description": "架构边界规则或分层约束变更时，必须同步架构文档。",
      "guidance": "至少更新 docs/project/ARCHITECTURE.md；必要时补充对应功能设计文档。",
      "code_patterns": [
