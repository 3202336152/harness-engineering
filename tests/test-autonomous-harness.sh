...
assert_json_field "$output" '.required_context | index("docs/project/核心信念.md") != null' "true"
...
assert_json_field "$restore_output" '.context_bundle | index("docs/project/核心信念.md") != null' "true"
