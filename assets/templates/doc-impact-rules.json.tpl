  ...
  "rules": [
    {
      ...
      "guidance": "至少更新 docs/project/接口规范.md 或对应功能目录下的 接口设计.md。",
      "code_patterns": [
    ...
    },
    {
      ...
      "guidance": "至少更新 docs/project/安全规范.md；如果只影响某个功能，也可以同时补充对应功能设计文档。",
      "code_patterns": [
      ...
      "required_doc_patterns_any": [
        ...
        "^docs/features/[^/]+/方案设计\\.md$"
      ]
    },
    {
      "id": "build-or-rollout-change",
      "description": "构建、配置、部署相关变更时，必须同步开发或发布文档。",
      "guidance": "至少更新 docs/project/开发规范.md，或对应功能目录下的 发布回滚.md。",
      "code_patterns": [
        "^pom\\.xml$",
        "^build\\.gradle$",
        "^build\\.gradle\\.kts$",
      ...
      "required_doc_patterns_any": [
        ...
        "^docs/features/[^/]+/发布回滚\\.md$"
      ]
    },
    {
      "id": "architecture-rule-change",
      "description": "架构边界规则或分层约束变更时，必须同步架构文档。",
      "guidance": "至少更新 docs/project/项目架构.md；必要时补充对应功能设计文档。",
      "code_patterns": [
